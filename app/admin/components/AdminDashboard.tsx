    ...
    <div className="space-y-6">
          ...
          <CardContent>
            <div className="space-y-3">
              {recentActivity.slice(0, 8).map((activity) => (
                ...
                >
                  <div
                    className={`mt-1 rounded-full p-1.5 ${getStatusColor(activity.status)}`}
                  >
            ...
            <div className="space-y-4">
              {enrollmentByGrade.map((grade) => {
                const maxCount = Math.max(
                  ...enrollmentByGrade.map((g) => g.count)
                );
      ...
      <Card className="bg-gradient-to-r from-red-50 to-orange-50">
        <CardHeader>
          ...
          <CardDescription>
            Your authorized administrative functions
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <CardContent className="space-y-2">
            <div className="flex justify-between">
              ...
              <span className="font-medium">
                {Math.round(stats.totalStudents * (stats.attendanceRate / 100))}
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-sm text-muted-foreground">
