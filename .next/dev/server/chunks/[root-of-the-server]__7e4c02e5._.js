...
"[project]/app/api/grades/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const { data, error } = await admin.from('grades').select('*').eq('student_id', studentId).order('subject');
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7e4c02e5._.js.map