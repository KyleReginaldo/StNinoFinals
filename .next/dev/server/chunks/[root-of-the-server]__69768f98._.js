...
"[project]/app/api/parent/student-stats/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const { data: grades, error: gradesError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('grades').select('grade').eq('student_id', studentId);
        let gpa = 0;
        ...
        const { data: attendanceRecords, error: attendanceError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('attendance_records').select('status').eq('user_id', studentId);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__69768f98._.js.map