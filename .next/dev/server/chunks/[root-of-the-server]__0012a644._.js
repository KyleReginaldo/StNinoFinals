...
"[project]/app/api/admin/students/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(request, { params }) {
    try {
        ...
        const { first_name, last_name, middle_name, student_number, grade_level, section, email, phone_number, date_of_birth, address, rfid } = body;
        const supabaseAdmin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSupabaseAdmin"])();
        ...
        // Update user record
        const { error: updateError } = await supabaseAdmin.from('users').update(updateData).eq('id', id).eq('role', 'student');
        if (updateError) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
...
async function DELETE(request, { params }) {
    try {
        ...
        const { error: deleteError } = await supabaseAdmin.from('users').delete().eq('id', id).eq('role', 'student');
        if (deleteError) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0012a644._.js.map