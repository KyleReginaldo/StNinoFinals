...
"[project]/app/api/admin/enrollment-requests/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    let query = supabase.from('enrollment_requests').select(`*, student:users!enrollment_requests_student_id_fkey(id, first_name, last_name, email)`).order('created_at', {
        ascending: false
    });
...
async function PATCH(request) {
    try {
        ...
        if (status === 'approved' && !classId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: 'classId is required when approving'
            }, {
                status: 400
            });
        }
        ...
        const { data: enrollmentRequest, error: fetchError } = await supabase.from('enrollment_requests').select('id, student_id').eq('id', requestId).single();
        ...
        const { error: updateError } = await supabase.from('enrollment_requests').update(updatePayload).eq('id', requestId);
        if (updateError) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e2a292a3._.js.map