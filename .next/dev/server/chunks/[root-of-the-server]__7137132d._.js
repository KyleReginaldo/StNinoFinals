...
"[project]/app/api/admin/grades/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const { data, error } = await admin.from('grades').select(`
        id,
        grade,
        subject,
        status,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7137132d._.js.map