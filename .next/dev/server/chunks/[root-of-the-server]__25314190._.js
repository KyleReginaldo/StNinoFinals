...
"[project]/app/api/admin/class-subjects/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    try {
        ...
        const { data, error } = await supabase.from('class_subjects').select('id, subject_name, created_at').eq('class_id', classId).order('subject_name');
...
async function POST(request) {
    try {
        ...
        if (!classId || !subjectName?.trim()) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: 'classId and subjectName are required'
            }, {
                status: 400
            });
        }
        ...
        }).select('id, subject_name, created_at').single();
        if (error) {
            if (error.code === '23505') {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    success: false,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__25314190._.js.map