...
"[project]/app/api/teacher/journal/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const { data: journalEntries, error } = await admin.from('journal_entries').select('*').eq('teacher_id', teacherId).order('date', {
            ascending: false
        });
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7faba398._.js.map