...
"[project]/app/api/parent/student-attendance/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const { data: attendanceRecords, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('attendance_records').select('*').eq('user_id', studentId).gte('scan_datetime', startDate.toISOString()).order('scan_datetime', {
            ascending: false
        });
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__083d4507._.js.map